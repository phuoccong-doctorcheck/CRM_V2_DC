...
const FormBookingCustomerSalesOrder: React.FC<FormAddCustomerProps> = ({
  handleClose,
  handleAddCustomer,
  valUpdate,
  isUpdate,
  ...
  noOverLay,
  isLoadingB,
  handleLoading, listDataServices,
  dataSaleOrderRef
}) => {
  moment.locale("vi");
      ...
      if (serviceSelected.length !== 0) {
        ...
        const request = {
          ...
          is_from_saleorder: true,
            ...
            launch_source_group_id: dataForm?.originGroup?.value || 2,
            launch_source_id: dataForm?.origin?.value || 202,
            launch_source_type_id: dataForm?.originType?.value || 6,
  ...
  useEffect(() => {
    ...
    console.log("🚀- listServices:", listServices,listDataServices);
    if (isUpdate) {
...
FormBookingCustomerSalesOrder.defaultProps = {
...
export default FormBookingCustomerSalesOrder;
