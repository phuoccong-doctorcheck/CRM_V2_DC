...
const FormUpdateBookingCustomer: React.FC<FormAddCustomerProps> = ({
  handleClose,
  handleAddCustomer,
  valUpdate,
  isUpdate,
      ...
      },
      {
        ...
        render: (record: any, data: any) => (
          ...
          >
            {" "}
            <Typography
              content={record === null ? "N/A" :record}
              modifiers={["12x18", "400", "center"]}
            />{" "}
          </div>
        ),
    ...
    if (isUpdate) {
     ...
     const delay = setTimeout(() => {
            ...
            setDataForm({
              ...
              origin:
                (stateLaunchSource.find(
                  (i) => i.id == valUpdate?.launch_source_id
                ) as any),
              originGroup:
                (stateLaunchSourceGroups.find(
                  (i) => i.id == valUpdate?.launch_source_group_id
                ) as any) ,
              ...
              dateBooking:
                  ...
                  valUpdate?.appointment_date,
                
              noteBooking: valUpdate?.master_note,
              ...
              typeBooking:  (stateAppointmentTypes.find(
                  (i) =>
                    i.value ===
              ...
              ctv: listAffiliates.find(
                (i: any) => i?.affiliate_code === valUpdate?.owner_id
              ) as unknown as DropdownData,
              ctvBSCD: listAffiliates.find(
                (i: any) => i?.affiliate_code === valUpdate?.owner_id
              ) as unknown as DropdownData,
...
FormUpdateBookingCustomer.defaultProps = {
...
export default FormUpdateBookingCustomer;
