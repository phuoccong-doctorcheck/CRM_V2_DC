...
const PublicTableTask: React.FC<PublicTableProps> = ({
  ...
  return (
    <div className={mapModifiers('m-public_tableT', isNormal && 'small', isSimpleHeader && 'simple', isHideBody && 'hide_body', !textHeader?.trim() && 'hide_title')}>
      <Table
        columns={column}
...
export default PublicTableTask;
