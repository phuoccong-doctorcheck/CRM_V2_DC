...
const PublicTableBusiness: React.FC<PublicTableProps> = ({
  ...
  defaultExpandAllRow, scroll, handleOnchange, tableRef, handleSelectRow, handleSelectAllRow, expandedRowKeys, handleSelectMultiple,onExpand,expandIcon,
  ...props
}) => {
...
PublicTableBusiness.defaultProps = {
  size: 'small',
  pageSizes: 15,
...
export default PublicTableBusiness;
