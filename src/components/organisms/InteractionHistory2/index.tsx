...
const InteractionHistory2: React.FC<InteractionHistoryProps> = ({ options, id, isPopup, get5Item, loadingNote, handleChangeType, typeNote ,chatBox}) => {
...
InteractionHistory2.defaultProps = {
  isPopup: false,
};

export default InteractionHistory2;
