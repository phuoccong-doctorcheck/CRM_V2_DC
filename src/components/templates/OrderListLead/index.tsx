...
const OrderListLead = ({setIsSelectService,ordersList,setDataRemove,setIsUpdateInfo,setListDataServices,setDataSaleOrderRef,setServiceSelected,setIsSeenPrice}: OrderListProps) => {
  const orders: Order[] = [
    {
      id: "1",
      name: "Đơn hàng 1",
  ...
  const [saleOR, setSaleOR] = useState("")
