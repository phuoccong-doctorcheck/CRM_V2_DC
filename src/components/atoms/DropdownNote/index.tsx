...
const DropdownNote: React.FC<DropdownProps> = ({
  ...
  return (
    <div className={mapModifiers('a-dropdownNote', isFlex && 'flex', variant, isState && values?.id?.toString()?.toLowerCase(), error && 'error', isColor && 'color')}>
