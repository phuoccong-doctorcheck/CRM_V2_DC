...
const InputDateOfBirth2: React.FC<InputDateOfBirthProps> = ({
  ...
  return (
    <div className={mapModifiers('a-birth_day',
      ...
      {label && (
        <label style={{ marginBottom:"4px"}} className="a-birth_day_label" htmlFor={id}>
          {label}
...
InputDateOfBirth2.defaultProps = {
};

export default InputDateOfBirth2;
